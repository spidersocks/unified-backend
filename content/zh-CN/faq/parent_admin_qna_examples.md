...
folder: faq
aliases: 母语老师; 外教; 教师资格; 评估费; 班级人数; 补课政策; 天气安排; 八号风球; 黑雨; 付款; FPS; 圣诞营业; 写作班; 面试班; 时间表; 口才训练; 课程咨询; 课表; 上课安排; drop-off; 兄弟姐妹
---
# 家长与行政对话（标准回复示例）
...
答：我们在红色暴雨、黄色／琥珀色暴雨及一号／三号风球期间照常上课。黑色暴雨或八号（或更高）风球期间停课。如出行不便或对幼童不安全，请联系我们作安排。
...
问：完成全部拼音课程需时多久？  
答：拼音课程共分 8 级，一般需约 1.5 年完成，实际进度视练习情况而定。
...
答：家长您好！由于课程需根据每位孩子及教室资源精准安排，暂无法线上直接确认。请通过官方 WhatsApp 联系课程顾问，我们会立即协助查询并协调最合适的上课安排。感谢理解！

---

# 行程／请假 — 例子与政策回复规则

属于通知或操作请求（仅回复 [NO_ANSWER]）
- “下周需要请假。” → [NO_ANSWER]
- “抱歉 11/5 Julian 不能上课。” → [NO_ANSWER]
- “能否取消本周五 3 点的课程？” → [NO_ANSWER]

属于政策问题（可回复政策；避免做安排）
- “Tristan 12 月 19 日不在。改期政策是什么？”  
建议回复要点（摘自《补课与请假政策》）：
- 取消课需至少提前 4 小时通知；
- 补课须在课程有效期内安排（常见免费配额：8 节→2 次；10 节→3 次）；
- 未通知缺席需收费且不设补课；
- 病假请提供医生证明以便安排补课；
- 所有课程须在首节起计 3 个月内完成。  
（请勿在聊天中做出或确认任何安排；由工作人员跟进。）
---