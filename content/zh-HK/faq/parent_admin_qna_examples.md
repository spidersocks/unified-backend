...
folder: faq
aliases: 母語老師; 外籍老師; 教師資格; 評估費; 班級人數; 補課政策; 天氣安排; 八號風球; 黑雨; 付款; FPS; 聖誕營業; 寫作班; 面試班; 時間表; 口才訓練; 課程查詢; 課表; 諮詢; 上課安排; drop-off; 兄弟姊妹
---
# 家長與行政對話（標準回覆示例）
...
答：我們於紅色暴雨、黃色／琥珀色暴雨及一號／三號風球期間照常上課。黑色暴雨或八號（或更高）風球期間停課。如出行不便或對幼童不安全，請聯絡我們作安排。
...
答：家長您好！由於課程需根據每位孩子及教室資源作精準安排，暫無法線上直接確認。請透過官方 WhatsApp 聯絡課程顧問，我們會即時協助查詢並協調最合適的上課安排。感謝理解！

---

# 行程／請假 — 例子與政策回覆規則

屬於通知或操作請求（僅回覆 [NO_ANSWER]）
- 「下星期要請假。」→ [NO_ANSWER]
- 「抱歉 11/5 Julian 唔嚟上堂。」→ [NO_ANSWER]
- 「可否取消今個星期五 3pm 課堂？」→ [NO_ANSWER]

屬於政策問題（可回覆政策；避免作安排）
- 「Tristan 12 月 19 日唔喺度。改期政策係點？」  
建議回覆要點（擷取自《補課與請假政策》）：
- 取消課需最少提前 4 小時通知；
- 補課須於課程期限內安排（常見免費配額：8 堂→2 次；10 堂→3 次）；
- 無通知缺席需收費且不設補課；
- 病假請提供醫生證明以便安排補課；
- 所有課程須在首堂起計 3 個月內完成。  
（請勿在聊天中作出或確認任何安排；由職員跟進。）
---